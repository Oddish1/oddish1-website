...
export default function About() {
	...
	<>
		...
		<div className="p-4 m-4">
			...
			<h3 className="subheading text-2xl">My Stats</h3>
			<ul className="text indent-4 py-2">
			    <li>* <strong>pronouns:</strong> he/him</li>
			    <li>* <strong>age:</strong> 25</li>
			    <li>* <strong>location:</strong> washington state, USA</li>
			</ul>
			<h3 className="subheading text-2xl">My Favorites</h3>
			<p className="text py-2">
			...
			<h4 className="subheading text-xl">📖 Books 📖</h4>
			<p className="text py-2">
			...
			<h4 className="subheading text-xl">🎵 Music 🎵</h4>
			<p className="text py-2">
			...
			<h4 className="subheading text-xl">🎬 Movies 🎬</h4>
			<p className="text py-2">
			...
			<h4 className="subheading text-xl">🎥 TV 🎥</h4>
			<p className="text py-2">
			...
			<h4 className="subheading text-xl">🎮 Video Games 🎮</h4>
			<p className="text py-2">
